...
LAUNCHER="${ROOT}/scripts/scaling/launch_microlens1m_retrain_clean_cell.sh"
...
JOBS=(
  "I03-seater tiger_compat M01-t5s I03_M01"
  "I03-seater tiger_compat M02-t5b I03_M02"
  "I03-seater tiger_compat M03-t5l I03_M03"
...
while true; do
  if all_started; then
    echo "[$(timestamp)] all queued MicroLens-1M retrain-clean cells have been started"
    exit 0
  fi
