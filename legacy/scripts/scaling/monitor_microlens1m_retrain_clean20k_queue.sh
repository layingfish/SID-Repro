...
LOG_ROOT="${ROOT}/logs/scaling_microlens1m_retrain_clean20k"
LAUNCHER="${ROOT}/scripts/scaling/launch_microlens1m_retrain_clean20k_cell.sh"
LAUNCHER_LOG_DIR="${LOG_ROOT}/launchers"
GPU_LIST="${GPU_LIST:-0 1 4}"
...
JOBS=(
  "I03-seater tiger_compat M01-t5s I03_M01_20k"
  "I03-seater tiger_compat M02-t5b I03_M02_20k"
  "I05-letter tiger_compat M01-t5s I05_M01_20k"
  "I05-letter tiger_compat M02-t5b I05_M02_20k"
)
...
compat_ready() {
  local id_dir="$1"
  local compat_dir="$2"
  local compat_root="${ASSET_ROOT}/${id_dir}/${compat_dir}"
...
while true; do
  if all_started; then
    echo "[$(timestamp)] all queued MicroLens-1M retrain-clean20k cells have been started"
    exit 0
  fi
