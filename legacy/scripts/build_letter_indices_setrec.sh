...
emb_path="$RECSYS26_ROOT/third_party/SETRec/data/$domain/${domain}.emb-t5-tdcb.npy"
cf_emb_path="$RECSYS26_ROOT/third_party/SETRec/data/$domain/SASRec_item_embed.pkl"
...
index_out="${RECSYS26_LETTER_TOKENIZER_INDEX_OUT:-$RECSYS26_ROOT/third_party/LETTER/data/SETRec_${domain}/SETRec_${domain}.index.json}"

source "$RECSYS26_ROOT/scripts/conda_activate.sh" recsys26_letter
cd "$RECSYS26_ROOT/third_party/LETTER"
...
# Ensure we can import LETTER RQ-VAE modules.
RQVAE_DIR = Path("/data/xqp_data/RecSys26/third_party/LETTER/RQ-VAE")
import sys
