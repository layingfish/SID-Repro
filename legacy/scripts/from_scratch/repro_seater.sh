...
SEATER_CODE_DIR="$RECSYS26_ROOT/third_party_clean/SEATER"
DATA_PATH="$RECSYS26_ROOT/datasets/seater_setrec/${domain}"
...
run_dir="$RECSYS26_ROOT/logs/repro_from_scratch/seater/${domain}/$(now_ts)"
mkdir -p "$run_dir"
