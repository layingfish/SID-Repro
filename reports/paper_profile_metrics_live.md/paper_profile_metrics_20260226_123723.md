# Paper-profile metrics snapshot (20260226_123723 UTC)
...
- steam: exit=? run=`logs/repro_paper/tiger/steam/20260226_091635/run.log`
...
- sports: exit=0 run=`logs/repro_paper/letter/sports/20260226_104855/run.log`
  - results.json
- steam: exit=? run=`logs/repro_paper/letter/steam/20260226_113958/run.log`
