# Paper-profile metrics snapshot (20260226_084819 UTC)
...
- sports: exit=143 run=`logs/repro_paper/eager/sports/20260226_014841/run.log`
...
- sports: exit=0 run=`logs/repro_paper/etegrec/sports/20260226_070152/run.log`
...
- sports: exit=? run=`logs/repro_paper/llm_id/sid/sports/20260226_061022/run.log`
  - Test(last): hit@5=0.005811965811965812 hit@10=0.008205128205128205 ncdg@5=0.0038576995025618207 ncdg@10=0.004630953138758615
- steam: -
...
- steam: exit=? run=`logs/repro_paper/seater/steam/20260226_080744/run.log`
...
- toys: exit=? run=`logs/repro_paper/tiger/toys/20260226_074209/run.log`
- sports: exit=? run=`logs/repro_paper/tiger/sports/20260226_080100/run.log`
- steam: exit=? run=`logs/repro_paper/tiger/steam/20260226_080341/run.log`
