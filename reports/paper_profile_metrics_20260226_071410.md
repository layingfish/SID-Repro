# Paper-profile metrics snapshot (20260226_071410 UTC)
...
- sports: exit=? run=`logs/repro_paper/etegrec/sports/20260226_070152/run.log`
- steam: -
...
- sports: exit=? run=`logs/repro_paper/llm_id/sid/sports/20260226_061022/run.log`
  - Test(last): hit@5=0.008205128205128205 hit@10=0.01094017094017094 ncdg@5=0.005017627454942804 ncdg@10=0.005885670237093398
- steam: -
...
- sports: exit=0 run=`logs/repro_paper/rpg/sports/20260226_063332/run.log`
...
- steam: exit=? run=`logs/repro_paper/seater/steam/20260226_063632/run.log`
