# Paper-profile metrics snapshot (20260225_234519 UTC)
...
- beauty: exit=0 run=`logs/repro_paper/seater/beauty/20260225_164046/run.log`
  - test:  {'ndcg@20': np.float64(0.0109), 'ndcg@50': np.float64(0.0149), 'hit@20': 0.0473, 'hit@50': 0.0799, 'recall@20': 0.0209, 'recall@50': 0.0372}
- toys: exit=0 run=`logs/repro_paper/seater/toys/20260225_212405/run.log`
  - test:  {'ndcg@20': np.float64(0.0101), 'ndcg@50': np.float64(0.0136), 'hit@20': 0.0473, 'hit@50': 0.0727, 'recall@20': 0.0212, 'recall@50': 0.0347}
- sports: exit=0 run=`logs/repro_paper/seater/sports/20260225_230359/run.log`
  - test:  {'ndcg@20': np.float64(0.0145), 'ndcg@50': np.float64(0.02), 'hit@20': 0.069, 'hit@50': 0.1159, 'recall@20': 0.0259, 'recall@50': 0.0465}
- steam: -

### setrec
- beauty: exit=0 run=`logs/repro_paper/setrec/beauty/20260225_175518/run.log`
  - All: R@5=0.0295 R@10=0.059 N@5=0.0252 N@10=0.0363 (best_beta=0.3)
- toys: exit=0 run=`logs/repro_paper/setrec/toys/20260225_181726/run.log`
  - All: R@5=0.0512 R@10=0.0863 N@5=0.037 N@10=0.0491 (best_beta=0.7)
- sports: exit=0 run=`logs/repro_paper/setrec/sports/20260225_192305/run.log`
  - All: R@5=0.0359 R@10=0.061 N@5=0.0248 N@10=0.0333 (best_beta=1.0)
- steam: exit=0 run=`logs/repro_paper/setrec/steam/20260225_200448/run.log`
  - All: R@5=0.0316 R@10=0.0656 N@5=0.0243 N@10=0.0373 (best_beta=0.5)
