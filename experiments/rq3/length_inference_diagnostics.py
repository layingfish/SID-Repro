...
EVAL_ROOT = Path(__file__).resolve().parents[2] / "pipeline" / "evaluation"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data_dir", type=Path, default=Path(os.environ.get("DATA_ROOT", default_root / "data")))
