...
EAGER_CODE_DIR="${EAGER_CODE_DIR:-$RECSYS26_ROOT/baselines/ref08}"
EAGER_REPO_DIR="${EAGER_REPO_DIR:-$RECSYS26_ROOT/baselines/ref08}"
...
run_dir="${RECSYS26_RUN_DIR:-$RECSYS26_ROOT/logs/repro_from_scratch/eager/${domain}/$(now_ts)}"
mkdir -p "$run_dir"
