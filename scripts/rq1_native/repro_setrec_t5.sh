...
SETREC_CODE_DIR="${SETREC_CODE_DIR:-$RECSYS26_ROOT/baselines/reference/code}"
DATA_PATH="${SETREC_DATA_PATH:-../data/${domain}/}"
CACHE_DIR="${CACHE_DIR:-$MODEL_ROOT/hf/transformers}"
...
run_dir="${RECSYS26_RUN_DIR:-$RECSYS26_ROOT/logs/repro_from_scratch/setrec/${domain}/$(now_ts)}"
mkdir -p "$run_dir"
